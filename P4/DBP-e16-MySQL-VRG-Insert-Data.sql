...
/*																				*/
/*	The View Ridge Gallery Database (VRG) - Insert Data							*/
/*																				*/
...
/*																				*/
/*	NOTE:  For MySQL, we use NULL when inserting the next sequential			*/
/*  AUTO_INCREMENT value into a table. This is specific to MySQL.				*/
/*  Non-sequential primary key values can be inserted directly, which			*/
/*  is done for the VRG data used here.											*/
/*																				*/
/********************************************************************************/
...
INSERT INTO WORK (WorkID, Title, Copy, Medium, Description, ArtistID)
	VALUES (
	590, 'Blue Interior', 'Unique', 'Tempera on card',
    '43.9 x 28 in.', 17);
INSERT INTO WORK (WorkID, Title, Copy, Medium, Description, ArtistID)
	VALUES (
	593, 'Surf and Bird', 'Unique', 'Gouache',
...
INSERT INTO TRANS (TransactionID, DateAcquired, AcquisitionPrice,
	AskingPrice, DateSold, SalesPrice, CustomerID, WorkID)
 	VALUES (
	100, '2017/11/4', 30000.00, 45000.00, '2017/12/14', 42500.00, 1000, 500);
INSERT INTO TRANS (TransactionID, DateAcquired, AcquisitionPrice,
	AskingPrice, DateSold, SalesPrice, CustomerID, WorkID)
 	VALUES (
	101, '2017/11/7', 250.00, 500.00, '2017/12/19', 500.00,	1015, 511);
INSERT INTO TRANS (TransactionID, DateAcquired, AcquisitionPrice,
	AskingPrice, DateSold, SalesPrice, CustomerID, WorkID)
 	VALUES (
...
INSERT INTO TRANS (TransactionID, DateAcquired, AcquisitionPrice,
	AskingPrice, WorkID)
 	VALUES (
	126, '2018/11/21', 200.00, 400.00, 552);
INSERT INTO TRANS (TransactionID, DateAcquired, AcquisitionPrice,
	AskingPrice, DateSold, SalesPrice, CustomerID, WorkID)
 	VALUES (
...
INSERT INTO TRANS (TransactionID, DateAcquired, AcquisitionPrice,
	AskingPrice, WorkID)
 	VALUES (
	155, '2019/05/18', 250.00, 500.00, 565);
INSERT INTO TRANS (TransactionID, DateAcquired, AcquisitionPrice,
	AskingPrice, DateSold, SalesPrice, CustomerID, WorkID)
 	VALUES (
...
INSERT INTO TRANS (TransactionID, DateAcquired, AcquisitionPrice,
	AskingPrice, WorkID)
 	VALUES ( 	
	181, '2019/10/11', 250.00, 500.00, 578);
INSERT INTO TRANS (TransactionID, DateAcquired, AcquisitionPrice,
	AskingPrice, DateSold, SalesPrice, CustomerID, WorkID)
 	VALUES ( 	
...
INSERT INTO TRANS (TransactionID, DateAcquired, AcquisitionPrice,
	AskingPrice, WorkID)
 	VALUES ( 	
	226, '2020/06/08', 200.00, 400.00, 586);
INSERT INTO TRANS (TransactionID, DateAcquired, AcquisitionPrice,
	AskingPrice, DateSold, SalesPrice, CustomerID, WorkID)
 	VALUES ( 	
...
INSERT INTO TRANS (TransactionID, DateAcquired, AcquisitionPrice,
	AskingPrice, WorkID)
 	VALUES ( 	
	228, '2020/06/08', 250.00, 500.00, 588);
INSERT INTO TRANS (TransactionID, DateAcquired, AcquisitionPrice,
	AskingPrice, WorkID)
 	VALUES ( 	
	229, '2020/06/08', 250.00, 500.00, 589);
INSERT INTO TRANS (TransactionID, DateAcquired, AcquisitionPrice,
	AskingPrice, DateSold, SalesPrice, CustomerID, WorkID)
 	VALUES ( 	
...
INSERT INTO TRANS (TransactionID, DateAcquired, AcquisitionPrice,
	AskingPrice, WorkID)
 	VALUES ( 	
	251, '2020/10/25', 25000.00, 50000.00, 593);
INSERT INTO TRANS (TransactionID, DateAcquired, AcquisitionPrice,
	AskingPrice, WorkID)
 	VALUES ( 	
	252, '2020/10/27', 250.00, 500.00, 594);
INSERT INTO TRANS (TransactionID, DateAcquired, AcquisitionPrice,
	AskingPrice, WorkID)
 	VALUES ( 	
	253, '2020/10/27', 250.00, 500.00, 595);
INSERT INTO TRANS (TransactionID, DateAcquired, AcquisitionPrice,
	AskingPrice, WorkID)
 	VALUES ( 	
	254, '2020/10/27', 250.00, 500.00, 596);
